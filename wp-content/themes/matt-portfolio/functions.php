...
function matt_portfolio_setup() {
	 ...
	 * to change 'matt-portfolio' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'matt-portfolio', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'matt-portfolio' ),
	) );
...
function matt_portfolio_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'matt-portfolio' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'matt-portfolio' ),
...
function matt_portfolio_scripts() {
	wp_enqueue_style( 'matt-portfolio-style', get_stylesheet_uri() );

	wp_enqueue_script( 'matt-portfolio-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'matt-portfolio-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
